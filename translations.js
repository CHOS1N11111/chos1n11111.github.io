...
const translations = {
  en: {
    ...
    dongqiudiProjectOverview: "DongqiudiPure Android is an unofficial Dongqiudi client that brings football news, fixtures, results, and competition statistics into a native Android interface. Readers can open articles with embedded media and comments, inspect match lineups and events, and move from league standings to team and player profiles. Custom news columns, competition selection, and locally saved preferences support a focused browsing experience, with light and dark themes and no advertising or betting content. Built with Kotlin and Jetpack Compose, the project remains in development.",
    dongqiudiScreenshotNews: "News feed",
    dongqiudiScreenshotArticle: "Article details",
    dongqiudiScreenshotMatches: "Fixtures and results",
    dongqiudiScreenshotMatchDetail: "Match lineups",
    dongqiudiScreenshotStandings: "League standings",
    dongqiudiScreenshotTeam: "Team profile",
    tiebaProjectOverview: "TiebaPure Android is a native Kotlin and Jetpack Compose client for Baidu Tieba that follows Android conventions for navigation, gestures, media, storage, and adaptive layouts. Visitors can browse recommendations, forums, search results, threads, nested replies, images, and videos without signing in; signed-in users can access messages, follows, favorites, check-ins, likes, posting, replies, and profile editing. Local features include filtering, history and reading-position recovery, offline thread storage, responsive phone and tablet layouts, custom reading fonts, and deep links. Posting, replies, and profile editing remain experimental; posting and replies must be enabled in settings.",
    civilizationProjectOverview: "Adaptive Strategic AI is a Gathering Storm AI overhaul designed to keep Deity games competitive from the opening through the victory screen. It replaces much of vanilla Deity's front-loaded spike with an era-scaled difficulty curve, while each major AI independently adjusts development, recovery, expansion, defense, pressure, and war plans based on its position and recent trend. The mod adjusts AI priorities and bonuses to improve settlement, economy, military readiness, city assaults, wartime production, and victory progress, while limiting recovery bonuses to AIs with confirmed broad or severe deficits. City production decisions and military actions remain controlled by the game's native AI. It does not spawn units or grant technologies, civics, resources, cities, or stored progress.",
    ...
    smartShotProjectOverview: "SmartShot is a native macOS utility that brings smart content-block selection, region and scrolling screenshots, image annotation, on-device OCR, privacy-aware history, and screen recording into one app. Capture processing stays on the Mac, with no account, analytics, or cloud upload service. Its browser extension can capture webpage content blocks and hand the resulting image to the native editor. The project targets macOS 14 and later and is under active development.",
    smartShotScreenshotMainWindow: "SmartShot main window",
    ...
    educationCoursesLabel: "Selected Courses:",
    educationCourses: "Natural Language Processing and Understanding · Machine Learning · Algorithms · Principles and Methods of Optimization · Data Structures · Probability Theory and Mathematical Statistics",
    ...
    smartShotDescription: "A native macOS utility for smart block, region, and scrolling screenshots, annotation, on-device OCR, and screen recording.",
  ...
  "zh-CN": {
    ...
    galleryZoomOut: "缩小",
    galleryError: "图片加载失败。",
    dongqiudiProjectOverview: "DongqiudiPure Android 是一款第三方懂球帝客户端，在原生 Android 界面中整合足球资讯、赛程赛果与赛事数据。用户可以阅读带有图片、视频和评论的资讯，查看比赛阵容与赛况，并从联赛积分榜进入球队和球员资料页。自定义资讯栏目、赛事选择和本地保存的偏好设置让浏览更聚焦，同时支持浅色与深色主题，不展示广告或博彩内容。项目使用 Kotlin 和 Jetpack Compose 构建，目前仍在开发中。",
    dongqiudiScreenshotNews: "资讯列表",
    dongqiudiScreenshotArticle: "资讯详情",
    dongqiudiScreenshotMatches: "赛程与赛果",
    dongqiudiScreenshotMatchDetail: "比赛阵容",
    dongqiudiScreenshotStandings: "联赛积分榜",
    dongqiudiScreenshotTeam: "球队资料",
    tiebaProjectOverview: "TiebaPure Android 是使用 Kotlin 与 Jetpack Compose 原生构建的第三方百度贴吧客户端，导航、手势、媒体播放、存储和自适应布局遵循 Android 平台惯例。未登录时可浏览推荐、贴吧列表、搜索结果、帖子、楼中楼、图片与视频；登录后可使用消息、关注、收藏同步、签到、点赞、发帖、回复和资料编辑等功能。本机功能还包括内容屏蔽、浏览历史与阅读位置恢复、帖子离线保存、手机和平板自适应布局、自定义阅读字体与深链接。发帖、回复和资料编辑仍属实验性功能；发帖和回复需在设置中开启。",
    civilizationProjectOverview: "Adaptive Strategic AI 是一款面向 Gathering Storm 规则集的 AI 改进模组，目标是让神级难度从开局到胜利阶段都保持竞争性。它以随时代增长的难度曲线替代原版神级难度过度集中的前期压力，并让每个主要 AI 根据自身位置与近期趋势独立调整发展、恢复、扩张、防御、施压和战争计划。模组通过调整 AI 的优先级和加成来改善定居、经济、军事准备、攻城、战时生产与不同胜利路线的表现，同时只向经确认存在广泛或严重落后情况的 AI 提供有限恢复支持。具体的城市生产决策与军事行动仍由游戏原生 AI 决定。它不会生成单位，也不会直接授予科技、市政、资源、城市或已储存的进度。",
    ...
    smartShotProjectOverview: "SmartShot 是一款原生 macOS 截图与录屏工具，将智能内容块选择、区域和长截图、图片标注、本地 OCR、注重隐私的历史记录与屏幕录制整合在同一应用中。截图处理全部留在本机，无需账号，也不使用分析遥测或云端上传服务。配套浏览器扩展可截取网页内容块，并将结果导入原生编辑器。项目面向 macOS 14 及以上系统，目前仍在开发中。",
    smartShotScreenshotMainWindow: "SmartShot 主界面",
    ...
    educationCoursesLabel: "精选课程：",
    educationCourses: "自然语言处理与理解 · 机器学习 · 算法 · 最优化原理与方法 · 数据结构 · 概率论与数理统计",
    ...
    smartSensAiDepartment: "威云创达（上海）人工智能科技有限公司（思特威 AI 部）",
    smartSensAiAffiliation: "思特威全资子公司",
    smartSensApplicationsDepartment: "应用部",
    smartSensDetailLocation: "中国上海市闵行区",
    smartSensWorkOverview: "在思特威担任软件开发实习生期间，我开发了一个领域专用 Agent，将自然语言测试需求转换为经过校验、可执行的工作流，通过将模型规划约束在已注册的测试能力范围内，并在执行前确定性检查参数、跨步骤数据依赖与设备状态，提高执行可靠性；相关功能已在标准与自定义场景中完成验证。我还开发了一套用于统一创建、运行和检查工作流的可视化桌面软件，目前已在公司内部使用。",
    smartSensAiPeriod: "2026.09 – 至今",
    smartSensApplicationsPeriod: "2026.07 – 2026.09",
    ...
    smartShotDescription: "一款原生 macOS 工具，支持智能内容块、区域与长截图、图片标注、本地 OCR 和屏幕录制。",
